...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "xixiyuyin";
    private static String CALENDARS_ACCOUNT_NAME = "XIXIYUYIN@xixiyuyin.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.boohee";
    private static String CALENDARS_DISPLAY_NAME = "XIXIYUYIN";
